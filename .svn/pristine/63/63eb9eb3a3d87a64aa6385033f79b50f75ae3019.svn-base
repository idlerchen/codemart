...
<head>
	...
	<body>
							...
							<div class="publish-layout-36qrT">
								<div class="left-zone-SkmeB">
									<div class="zone-container-TZ2Oi">
										<form action="ItemServlet?way=saveItem" method="POST" onsubmit="return validate();">
										<div class="form-container-1KbJe">
											<div id="type">
												<div class="form-title-1uBG7">选择您的开发类型</div>
												<div class="types-3nBQo clearfix visible">
													<ul>
											...
											<div class="developer-type-2OQ8r" id="developerType">
												<div class="form-title-1uBG7">选择您招募的开发者类型</div>
												<div>
												...
												<div class="form-item-content-2qXWl">
													...
													<div class="form-input-3zb0m">
														<div class="form-input-content-1jr_Y">
															<div><input type="text" maxlength="30" placeholder="30 字符以内" name="name" class="input-DvJ_0 block-1EHlh"></div>
														</div>
													</div>
												</div>
											</div>
											<div class="form-item-3JClL">
												<div class="form-item-content-2qXWl">
													<div class="form-label-2oVVe">项目行业</div>
													<div class="form-input-3zb0m">
														<div class="form-input-content-1jr_Y">	
															<div>
											...
											<div class="form-item-3JClL" id="price">
												<div class="form-item-content-2qXWl">
													...
													<div class="form-input-3zb0m">
														<div class="form-input-content-1jr_Y">
															<div><input type="text" name="money" value="" maxlength="7" placeholder="个人项目金额≦ ¥50,000" class="input-DvJ_0 mid-input-idDSz" id="moneyinput"><span class="unit-1Abif">元</span><span class="bargain-3OiAD">
																</span>
															</div>
											...
											<div class="form-item-3JClL" id="duration">
												<div class="form-item-content-2qXWl">
													...
													<div class="form-input-3zb0m">
														<div class="form-input-content-1jr_Y">
															<div><input type="text" name="period" value="" maxlength="7" placeholder="请输入交付周期" class="input-DvJ_0 mid-input-idDSz" id="periodinput"><span class="unit-1Abif">天</span></div>
														</div>
													</div>
												</div>
											</div>
											<div class="form-item-3JClL" id="description">
												<div class="form-item-content-2qXWl">
													...
													<div class="form-input-3zb0m">
														<div class="form-input-content-1jr_Y">
															<div><textarea id="detailinput" class="ant-input textarea-1WPnK" type="textarea" rows="4" placeholder="请尽量详细描述您的项目，以吸引更多有相关开发经验的开发者报名（20 个字符以上）" name="detail" style="height: 94px; min-height: 94px; overflow-y: hidden;"></textarea>
																...
																<div>
																	...
																	<div class="sample-link-1J0FZ">
																		<div class="input-box-2x92T"><input type="text" name="refer" value="" placeholder="请输入网址或应用名称" class="input-DvJ_0"><label class="no-3Baem">1</label></div>
																	</div>
																	<div class="sample-link-1J0FZ">
																...
																<div class="contact-2OFCL clearfix">
																	<div class="contact-content-1F2RU">
																		<div class="contact-item-tg0Dg">
																			<div class="sub-label-1Xw6E">您的姓名</div><input name="linkMan" value="${loginUser.realname }" placeholder="姓名" class="input-DvJ_0 block-1EHlh" id="linkMan"></div>
																		<div class="contact-item-tg0Dg">
																			<div class="sub-label-1Xw6E">您的邮箱</div><input name="linkEmail" value="${loginUser.email }" placeholder="邮箱" class="input-DvJ_0 block-1EHlh" id="linkEmail"></div>
																		<div class="contact-item-tg0Dg">
																			...
																			<div class="phone-2WGv-" tabindex="-1">
																				<div class="phone-content-2zkFs">
																					...
																					<div class="country-code-I4JHX">+86</div><input class="input-3fxHA" name="linkTelephone" value="${loginUser.telephone}" placeholder="手机号" id="linkTelephone"></div>
											...
											<div class="footer-3KelO clearfix"><span>
												<input class="button-3791w primary-32yiR" id="submitbutton" type="submit"  value="发布" style="width:100px">
		...
		<script src="jsmy/demandIssue.js"></script>
</body>
